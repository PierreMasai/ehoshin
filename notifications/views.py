...
def live_notification_list(request):
    ...
    try:
        num_to_fetch = request.GET.get('max', 100)  # If they don't specify, make it 5.
        ...
        num_to_fetch = 100  # If casting to an int fails, just make it 5.

    unread_list = [model_to_dict(n) for n in request.user.notifications.all()[0:num_to_fetch]]
